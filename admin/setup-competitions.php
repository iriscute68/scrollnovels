<?php
// Setup script for competitions system
require_once __DIR__ . '/../config/config.php';

echo "Setting up Competitions System...\n";
...
try {
    ...
    // Add columns to stories table if needed
    $pdo->exec("ALTER TABLE stories ADD COLUMN IF NOT EXISTS competition_id INT");
    $pdo->exec("ALTER TABLE stories ADD COLUMN IF NOT EXISTS competition_tags VARCHAR(500)");
    
    echo "\n✓ Competitions system setup complete!\n";
